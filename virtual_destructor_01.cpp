...
class BaseData
{
	public:
		...
		{
			data = new int[size];
			cout << "class BaseData value of data:" << size << endl;
		}
...
class DerivedData : public BaseData
{
	public:
		...
		DerivedData(int size, int extra_size) : BaseData(size)
		{
			...
			cout << "class DerivedData value of data:" << size << endl;
			cout << "class DerivedData value of extra data:" << extra_size << endl;
		}
